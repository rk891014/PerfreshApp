...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "AAkkkkuuMMMMMMMMMMMM";
    ...
    public static final String COLUMN_CUTTEDPRICE = "cuttedprice";
    ...
    public void addBook(String id, String name, String price,String productquantity, String cuttedprice,String discount,String url, int quantity){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_NAME, name);
        cv.put(COLUMN_PRICE, price);
        cv.put(COLUMN_PRODUCTQUANTITY, productquantity);
        cv.put(COLUMN_CUTTEDPRICE, cuttedprice);
